...
public class CatalogProductAttributeOptionEntityToAdd  implements java.io.Serializable {
    private com.magento.api.CatalogProductAttributeOptionLabelEntity[] label;
    ...
    public CatalogProductAttributeOptionEntityToAdd(
           com.magento.api.CatalogProductAttributeOptionLabelEntity[] label,
           int order,
           int is_default) {
           this.label = label;
           this.order = order;
     ...
     * @return label
     */
    public com.magento.api.CatalogProductAttributeOptionLabelEntity[] getLabel() {
        return label;
    }
     ...
     * @param label
     */
    public void setLabel(com.magento.api.CatalogProductAttributeOptionLabelEntity[] label) {
        this.label = label;
    }
