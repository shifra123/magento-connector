...
public class CatalogProductTagInfoEntity  implements java.io.Serializable {
    ...
    private com.magento.api.AssociativeEntity[] products;
    ...
    public CatalogProductTagInfoEntity(
           ...
           com.magento.api.AssociativeEntity[] products) {
           this.name = name;
           this.status = status;
     ...
     * @return products
     */
    public com.magento.api.AssociativeEntity[] getProducts() {
        return products;
    }
     ...
     * @param products
     */
    public void setProducts(com.magento.api.AssociativeEntity[] products) {
        this.products = products;
    }
