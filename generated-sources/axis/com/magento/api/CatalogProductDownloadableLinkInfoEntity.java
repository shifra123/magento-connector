...
public class CatalogProductDownloadableLinkInfoEntity  implements java.io.Serializable {
    private com.magento.api.CatalogProductDownloadableLinkEntity[] links;

    private com.magento.api.CatalogProductDownloadableLinkSampleEntity[] samples;

    public CatalogProductDownloadableLinkInfoEntity() {
    }

    public CatalogProductDownloadableLinkInfoEntity(
           com.magento.api.CatalogProductDownloadableLinkEntity[] links,
           com.magento.api.CatalogProductDownloadableLinkSampleEntity[] samples) {
           this.links = links;
     ...
     * @return links
     */
    public com.magento.api.CatalogProductDownloadableLinkEntity[] getLinks() {
        return links;
    }
     ...
     * @param links
     */
    public void setLinks(com.magento.api.CatalogProductDownloadableLinkEntity[] links) {
        this.links = links;
    }
     ...
     * @return samples
     */
    public com.magento.api.CatalogProductDownloadableLinkSampleEntity[] getSamples() {
        return samples;
    }
     ...
     * @param samples
     */
    public void setSamples(com.magento.api.CatalogProductDownloadableLinkSampleEntity[] samples) {
        this.samples = samples;
    }
