    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public CancelOrderMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedOrderId = ((String) evaluateAndTransform(getMuleContext(), event, CancelOrderMessageProcessor.class.getDeclaredField("_orderIdType").getGenericType(), null, orderId));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((MagentoCloudConnector) object).cancelOrder(_transformedOrderId);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at MagentoCloudConnector at cancelOrder retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
