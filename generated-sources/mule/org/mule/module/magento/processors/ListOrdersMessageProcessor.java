    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public ListOrdersMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedFilter = ((String) evaluateAndTransform(getMuleContext(), event, ListOrdersMessageProcessor.class.getDeclaredField("_filterType").getGenericType(), null, filter));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                    ...
                    throws Exception
                {
                    ...
                    if ((_transformedFilter).startsWith("dsql:")) {
                        ...
                        return ((MagentoCloudConnector) object).listOrders(connector.toNativeQuery(q).toString());
                    } else {
                        return ((MagentoCloudConnector) object).listOrders(_transformedFilter);
                    }
                }
    ...
    public Result<MetaData> auxOutputMetaData(MetaData inputMetadata, String key) {
        if (((key) == null)||((key).toString() == null)) {
            return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error retrieving metadata from parameter: key at processor listOrders at module MagentoCloudConnector");
        }
        DefaultMetaDataKey metaDataKey = new DefaultMetaDataKey((key).toString(), null);
        metaDataKey.addProperty(new TypeDescribingProperty(TypeDescribingProperty.TypeScope.OUTPUT, "listOrders"));
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at MagentoCloudConnector at listOrders retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
