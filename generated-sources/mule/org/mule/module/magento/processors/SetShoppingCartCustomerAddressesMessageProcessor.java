    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    protected Object shoppingCartCustomerAddresses;
    protected List<ShoppingCartCustomerAddressEntity> _shoppingCartCustomerAddressesType;
    protected Object storeId;
    protected String _storeIdType;

    public SetShoppingCartCustomerAddressesMessageProcessor(String operationName) {
        super(operationName);
    }
    ...
    /**
     * Sets shoppingCartCustomerAddresses
     * 
     * @param value Value to set
     */
    public void setShoppingCartCustomerAddresses(Object value) {
        this.shoppingCartCustomerAddresses = value;
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final Integer _transformedQuoteId = ((Integer) evaluateAndTransform(getMuleContext(), event, SetShoppingCartCustomerAddressesMessageProcessor.class.getDeclaredField("_quoteIdType").getGenericType(), null, quoteId));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((MagentoCloudConnector) object).setShoppingCartCustomerAddresses(_transformedQuoteId, _transformedShoppingCartCustomerAddresses, _transformedStoreId);
                }
    ...
    public Result<MetaData> getInputMetaData() {
        return new DefaultResult<MetaData>(new DefaultMetaData(new DefaultListMetaDataModel(getPojoOrSimpleModel(ShoppingCartCustomerAddressEntity.class))));
    }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at MagentoCloudConnector at setShoppingCartCustomerAddresses retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
