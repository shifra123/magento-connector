    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public AddOrderShipmentCommentMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedShipmentId = ((String) evaluateAndTransform(getMuleContext(), event, AddOrderShipmentCommentMessageProcessor.class.getDeclaredField("_shipmentIdType").getGenericType(), null, shipmentId));
            final String _transformedComment = ((String) evaluateAndTransform(getMuleContext(), event, AddOrderShipmentCommentMessageProcessor.class.getDeclaredField("_commentType").getGenericType(), null, comment));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((MagentoCloudConnector) object).addOrderShipmentComment(_transformedShipmentId, _transformedComment, _transformedSendEmail, _transformedIncludeCommentInEmail);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at MagentoCloudConnector at addOrderShipmentComment retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
