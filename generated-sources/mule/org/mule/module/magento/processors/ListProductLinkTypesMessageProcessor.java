...
/**
 * ListProductLinkTypesMessageProcessor invokes the {@link org.mule.module.magento.MagentoCloudConnector#listProductLinkTypes()} method in {@link MagentoCloudConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@Generated(value = "Mule DevKit Version 3.5.0-SNAPSHOT", date = "2014-04-23T03:07:34-05:00", comments = "Build master.1920.518defc")
public class ListProductLinkTypesMessageProcessor
    extends AbstractConnectedProcessor
    implements MessageProcessor, OperationMetaDataEnabled
{


    public ListProductLinkTypesMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        try {
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((MagentoCloudConnector) object).listProductLinkTypes();
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at MagentoCloudConnector at listProductLinkTypes retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
