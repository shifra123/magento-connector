...
/**
 * ListOrdersInvoicesMessageProcessor invokes the {@link org.mule.module.magento.MagentoCloudConnector#listOrdersInvoices(java.lang.String)} method in {@link MagentoCloudConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@Generated(value = "Mule DevKit Version 3.5.0-SNAPSHOT", date = "2014-04-15T03:23:30-05:00", comments = "Build master.1915.dd1962d")
public class ListOrdersInvoicesMessageProcessor
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public ListOrdersInvoicesMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedFilter = ((String) evaluateAndTransform(getMuleContext(), event, ListOrdersInvoicesMessageProcessor.class.getDeclaredField("_filterType").getGenericType(), null, filter));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                    ...
                    throws Exception
                {
                    ...
                    if ((_transformedFilter).startsWith("dsql:")) {
                        ...
                        return ((MagentoCloudConnector) object).listOrdersInvoices(connector.toNativeQuery(q).toString());
                    } else {
                        return ((MagentoCloudConnector) object).listOrdersInvoices(_transformedFilter);
                    }
                }
    ...
    public Result<MetaData> auxOutputMetaData(MetaData inputMetadata, String key) {
        if (((key) == null)||((key).toString() == null)) {
            return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error retrieving metadata from parameter: key at processor listOrdersInvoices at module MagentoCloudConnector");
        }
        DefaultMetaDataKey metaDataKey = new DefaultMetaDataKey((key).toString(), null);
        metaDataKey.addProperty(new TypeDescribingProperty(TypeDescribingProperty.TypeScope.OUTPUT, "listOrdersInvoices"));
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at MagentoCloudConnector at listOrdersInvoices retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
