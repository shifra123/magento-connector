...
public class AddShoppingCartProductTestCases extends MagentoTestParent {
    ...
    public void setUp() throws Exception {
        initializeTestRunMessage("addShoppingCartProduct");
        ...
        initializeTestRunMessage("addShoppingCartProduct");
        upsertOnTestRunMessage("shoppingCartId", shoppingCartId);
    ...
    public void testAddShoppingCartProduct() {
        try {
            HashMap<Integer, Double> productIds = getTestRunMessageValue("productIds");
            Integer shoppingCartId = getTestRunMessageValue("shoppingCartId");
            ...
            upsertOnTestRunMessage("productsRef", productsRef);

            // Add the shopping cart products
            Boolean result = runFlowAndGetPayload("add-shopping-cart-product");
            assertTrue(result);
