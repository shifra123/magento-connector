...
public class AddOrderCommentTestCases extends MagentoTestParent {
    ...
    public void setUp() throws Exception {
        initializeTestRunMessage("addOrderComment");
        ...
        orderId = createShoppingCartOrder(quoteId, customer, addresses, paymentMethod, shippingMethod, shoppingCartProducts);
        initializeTestRunMessage("addOrderComment");
    ...
    public void testAddOrderComment() {
        try {
            Boolean result = runFlowAndGetPayload("add-order-comment");
            assertTrue(result);
        } catch (Exception e) {
