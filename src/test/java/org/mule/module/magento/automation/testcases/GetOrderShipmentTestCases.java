...
public class GetOrderShipmentTestCases extends MagentoTestParent {
    ...
    public void setUp() throws Exception {
        initializeTestRunMessage("getOrderShipment");
    ...
    public void testGetOrderShipment() {
        try {
            String shipmentId = getTestRunMessageValue("shipmentId");
            SalesOrderShipmentEntity shipment = runFlowAndGetPayload("get-order-shipment");
