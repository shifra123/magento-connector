...
public class ShoppingCartPaymentMethodResponseEntityArray  implements java.io.Serializable {
    ...
    private com.magento.api.AssociativeEntity[] cc_types;
    ...
    public ShoppingCartPaymentMethodResponseEntityArray(
           ...
           com.magento.api.AssociativeEntity[] cc_types) {
           this.code = code;
           this.title = title;
     ...
     * @return cc_types
     */
    public com.magento.api.AssociativeEntity[] getCc_types() {
        return cc_types;
    }
     ...
     * @param cc_types
     */
    public void setCc_types(com.magento.api.AssociativeEntity[] cc_types) {
        this.cc_types = cc_types;
    }
