...
public class ShoppingCartPaymentEntity  implements java.io.Serializable {
    ...
    private java.lang.String cc_cid_enc;
     ...
     * @param cc_cid_enc
     */
    public void setCc_cid_enc(java.lang.String cc_cid_enc) {
        this.cc_cid_enc = cc_cid_enc;
    }
     ...
     * @param cc_ss_owner
     */
    public void setCc_ss_owner(java.lang.String cc_ss_owner) {
        this.cc_ss_owner = cc_ss_owner;
    }
     ...
     * @param cc_ss_issue
     */
    public void setCc_ss_issue(java.lang.String cc_ss_issue) {
        this.cc_ss_issue = cc_ss_issue;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ShoppingCartPaymentEntity)) return false;
        ShoppingCartPaymentEntity other = (ShoppingCartPaymentEntity) obj;
        ...
        _equals = true && 
            ...
            ((this.cc_cid_enc==null && other.getCc_cid_enc()==null) || 
             (this.cc_cid_enc!=null &&
              this.cc_cid_enc.equals(other.getCc_cid_enc()))) &&
            ...
            ((this.cc_ss_owner==null && other.getCc_ss_owner()==null) || 
             (this.cc_ss_owner!=null &&
              this.cc_ss_owner.equals(other.getCc_ss_owner()))) &&
            ...
            ((this.cc_ss_issue==null && other.getCc_ss_issue()==null) || 
             (this.cc_ss_issue!=null &&
              this.cc_ss_issue.equals(other.getCc_ss_issue()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getCc_cid_enc() != null) {
            _hashCode += getCc_cid_enc().hashCode();
        }
        if (getCc_owner() != null) {
        ...
        if (getCc_ss_owner() != null) {
            _hashCode += getCc_ss_owner().hashCode();
        }
        ...
        if (getCc_ss_issue() != null) {
            _hashCode += getCc_ss_issue().hashCode();
        }
    ...
    static {
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("cc_cid_enc");
        elemField.setXmlName(new javax.xml.namespace.QName("", "cc_cid_enc"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("cc_ss_owner");
        elemField.setXmlName(new javax.xml.namespace.QName("", "cc_ss_owner"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("cc_ss_issue");
        elemField.setXmlName(new javax.xml.namespace.QName("", "cc_ss_issue"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
