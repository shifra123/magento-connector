...
public class MagentoServiceLocator extends org.apache.axis.client.Service implements com.magento.api.MagentoService {
    ...
    private java.lang.String Mage_Api_Model_Server_V2_HandlerPort_address = "http://magento151.it.zauber.com.ar/index.php/api/v2_soap/index/";
    ...
    public com.magento.api.Mage_Api_Model_Server_V2_HandlerPortType getMage_Api_Model_Server_V2_HandlerPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.magento.api.Mage_Api_Model_Server_V2_HandlerBindingStub _stub = new com.magento.api.Mage_Api_Model_Server_V2_HandlerBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.magento.api.Mage_Api_Model_Server_V2_HandlerPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.magento.api.Mage_Api_Model_Server_V2_HandlerBindingStub _stub = new com.magento.api.Mage_Api_Model_Server_V2_HandlerBindingStub(new java.net.URL(Mage_Api_Model_Server_V2_HandlerPort_address), this);
                _stub.setPortName(getMage_Api_Model_Server_V2_HandlerPortWSDDServiceName());
                return _stub;
            }
        }
