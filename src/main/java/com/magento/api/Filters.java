...
public class Filters  implements java.io.Serializable {
    private com.magento.api.AssociativeEntity[] filter;

    private com.magento.api.ComplexFilter[] complex_filter;

    public Filters() {
    }

    public Filters(
           com.magento.api.AssociativeEntity[] filter,
           com.magento.api.ComplexFilter[] complex_filter) {
           this.filter = filter;
     ...
     * @return filter
     */
    public com.magento.api.AssociativeEntity[] getFilter() {
        return filter;
    }
     ...
     * @param filter
     */
    public void setFilter(com.magento.api.AssociativeEntity[] filter) {
        this.filter = filter;
    }
     ...
     */
    public com.magento.api.ComplexFilter[] getComplex_filter() {
        return complex_filter;
    }
     ...
     */
    public void setComplex_filter(com.magento.api.ComplexFilter[] complex_filter) {
        this.complex_filter = complex_filter;
    }
