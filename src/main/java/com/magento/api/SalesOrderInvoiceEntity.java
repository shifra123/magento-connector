...
public class SalesOrderInvoiceEntity  implements java.io.Serializable {
    ...
    private com.magento.api.SalesOrderInvoiceItemEntity[] items;

    private com.magento.api.SalesOrderInvoiceCommentEntity[] comments;
    ...
    public SalesOrderInvoiceEntity(
           ...
           com.magento.api.SalesOrderInvoiceItemEntity[] items,
           com.magento.api.SalesOrderInvoiceCommentEntity[] comments) {
     ...
     * @return items
     */
    public com.magento.api.SalesOrderInvoiceItemEntity[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(com.magento.api.SalesOrderInvoiceItemEntity[] items) {
        this.items = items;
    }
     ...
     * @return comments
     */
    public com.magento.api.SalesOrderInvoiceCommentEntity[] getComments() {
        return comments;
    }
     ...
     * @param comments
     */
    public void setComments(com.magento.api.SalesOrderInvoiceCommentEntity[] comments) {
        this.comments = comments;
    }
