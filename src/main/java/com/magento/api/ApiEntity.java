...
public class ApiEntity  implements java.io.Serializable {
    ...
    private com.magento.api.ApiMethodEntity[] methods;
    ...
    public ApiEntity(
           ...
           com.magento.api.ApiMethodEntity[] methods) {
           this.title = title;
           this.name = name;
     ...
     * @return methods
     */
    public com.magento.api.ApiMethodEntity[] getMethods() {
        return methods;
    }
     ...
     * @param methods
     */
    public void setMethods(com.magento.api.ApiMethodEntity[] methods) {
        this.methods = methods;
    }
