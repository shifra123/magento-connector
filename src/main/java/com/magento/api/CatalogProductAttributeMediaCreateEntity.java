...
public class CatalogProductAttributeMediaCreateEntity  implements java.io.Serializable {
    private com.magento.api.CatalogProductImageFileEntity file;
    ...
    public CatalogProductAttributeMediaCreateEntity(
           com.magento.api.CatalogProductImageFileEntity file,
     ...
     * @return file
     */
    public com.magento.api.CatalogProductImageFileEntity getFile() {
        return file;
    }
     ...
     * @param file
     */
    public void setFile(com.magento.api.CatalogProductImageFileEntity file) {
        this.file = file;
    }
