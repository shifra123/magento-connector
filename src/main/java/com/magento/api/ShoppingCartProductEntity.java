...
public class ShoppingCartProductEntity  implements java.io.Serializable {
    ...
    private com.magento.api.AssociativeEntity[] options;

    private com.magento.api.AssociativeEntity[] bundle_option;

    private com.magento.api.AssociativeEntity[] bundle_option_qty;
    ...
    public ShoppingCartProductEntity(
           ...
           com.magento.api.AssociativeEntity[] options,
           com.magento.api.AssociativeEntity[] bundle_option,
           com.magento.api.AssociativeEntity[] bundle_option_qty,
     ...
     * @return options
     */
    public com.magento.api.AssociativeEntity[] getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(com.magento.api.AssociativeEntity[] options) {
        this.options = options;
    }
     ...
     */
    public com.magento.api.AssociativeEntity[] getBundle_option() {
        return bundle_option;
    }
     ...
     * @param bundle_option
     */
    public void setBundle_option(com.magento.api.AssociativeEntity[] bundle_option) {
        this.bundle_option = bundle_option;
    }
     ...
     */
    public com.magento.api.AssociativeEntity[] getBundle_option_qty() {
        return bundle_option_qty;
    }
     ...
     */
    public void setBundle_option_qty(com.magento.api.AssociativeEntity[] bundle_option_qty) {
        this.bundle_option_qty = bundle_option_qty;
    }
